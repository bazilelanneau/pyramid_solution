# The function, longest_slide_down(), takes an array representing possible distances from one level to the next of a pyramid and finds the longest possible path from the top to the bottom.
# This is not the most efficient solution but is an accurate representation of my current programming skills (20171108) as I came up with this solution entirely on my own.
